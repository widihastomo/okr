...
const sampleGoalTemplates = [
  // Penjualan Templates
  {
    ...
    keyResults: [
      { title: "Penjualan naik 40% dari bulan sebelumnya", targetValue: "40", unit: "persen" },
      { title: "Mendapat 300 pelanggan baru per bulan", targetValue: "300", unit: "pelanggan" },
      { title: "Tingkat konversi mencapai 8%", targetValue: "8", unit: "persen" }
    ],
    initiatives: [
  ...
  },
  {
    ...
    focusAreaTag: "penjualan",
    keyResults: [
      { title: "500 member baru bergabung", targetValue: "500", unit: "member" },
      { title: "Tingkat retention member 85%", targetValue: "85", unit: "persen" },
      { title: "Average order value member naik 25%", targetValue: "25", unit: "persen" }
    ],
    initiatives: [
  ...
  // Operasional Templates
  {
    ...
    keyResults: [
      { title: "Efisiensi produksi naik 30%", targetValue: "30", unit: "persen" },
      { title: "Reduce waste produksi hingga 15%", targetValue: "15", unit: "persen" },
      { title: "Lead time produksi turun 20%", targetValue: "20", unit: "persen" }
    ],
    initiatives: [
  ...
  },
  {
    ...
    focusAreaTag: "operasional",
    keyResults: [
      { title: "Biaya operasional turun 25%", targetValue: "25", unit: "persen" },
      { title: "Cost per unit produksi turun 20%", targetValue: "20", unit: "persen" },
      { title: "ROI operasional naik 15%", targetValue: "15", unit: "persen" }
    ],
    initiatives: [
  ...
  // Customer Service Templates
  {
    ...
    keyResults: [
      { title: "Customer satisfaction score 95%", targetValue: "95", unit: "persen" },
      { title: "Response time rata-rata 2 jam", targetValue: "2", unit: "jam" },
      { title: "First call resolution 80%", targetValue: "80", unit: "persen" }
    ],
    initiatives: [
  ...
  },
  {
    ...
    focusAreaTag: "customer_service",
    keyResults: [
      { title: "Average response time 2 jam", targetValue: "2", unit: "jam" },
      { title: "95% tiket resolved dalam 24 jam", targetValue: "95", unit: "persen" },
      { title: "Customer complaint rate turun 40%", targetValue: "40", unit: "persen" }
    ],
    initiatives: [
  ...
  // Marketing Templates  
  {
    ...
    keyResults: [
      { title: "Brand awareness naik 60%", targetValue: "60", unit: "persen" },
      { title: "Social media reach 100K per bulan", targetValue: "100000", unit: "reach" },
      { title: "Website traffic naik 80%", targetValue: "80", unit: "persen" }
    ],
    initiatives: [
  ...
  },
  {
    ...
    focusAreaTag: "marketing",
    keyResults: [
      { title: "1000 qualified leads per bulan", targetValue: "1000", unit: "leads" },
      { title: "Lead conversion rate 12%", targetValue: "12", unit: "persen" },
      { title: "Cost per lead turun 30%", targetValue: "30", unit: "persen" }
    ],
    initiatives: [
