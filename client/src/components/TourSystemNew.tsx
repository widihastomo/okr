...
const TOUR_STEPS: TourStep[] = [
  ...
  {
    id: "template-goals",
    title: "Template Goals - Koleksi Template",
    description:
      "Menu Template Goals menyediakan koleksi template siap pakai untuk berbagai departemen dan fokus bisnis. Template ini membantu Anda memulai dengan struktur goal yang sudah terbukti efektif dan dapat langsung diterapkan ke organisasi Anda.",
    icon: FileText,
    selector: '[data-tour="template-goals"]',
    position: "right",
    category: "navigation",
