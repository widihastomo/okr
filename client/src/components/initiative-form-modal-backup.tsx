...
export default function InitiativeFormModal({
  ...
  useEffect(() => {
    if (isEditMode && initiative) {
      ...
      setSuccessMetrics(
        (initiative as any)?.successMetrics || [{ name: "", target: "" }],
      );
    } else if (!isEditMode) {
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden">
          <DialogHeader className="pb-4 border-b">
            ...
            <DialogDescription className="text-sm text-gray-600 mt-2">
              {currentStep === 1 &&
                "Langkah 1: Informasi Dasar - Tentukan judul, angka target terkait, tujuan, dan metrik inisiatif"}
              {currentStep === 2 &&
                "Langkah 2: Rencana Pelaksanaan - Atur strategi implementasi dan definisi selesai"}
              {currentStep === 3 &&
                "Langkah 3: Detail Akhir - Tentukan tanggal, penanggung jawab, anggaran, dan prioritas"}
            </DialogDescription>
                        ...
                        <FormItem>
                          <FormLabel className="flex items-center gap-2">
                            ...
                            <Popover>
                              ...
                              <PopoverContent side="right" className="max-w-xs">
                                <p className="text-sm">
                                  Jelaskan tujuan dan alasan mengapa inisiatif
                                  ini penting untuk mencapai angka target.
                                </p>
                              </PopoverContent>
                            </Popover>
                          </FormLabel>
                  ...
                  <CardContent className="space-y-6">
                        ...
                        <FormItem>
                          <FormLabel className="flex items-center gap-2">
                            ...
                            <Popover>
                              ...
                              <PopoverContent side="right" className="max-w-xs">
                                <p className="text-sm">
                                  Langkah-langkah detail yang akan dilakukan
                                  untuk menjalankan inisiatif ini.
                                </p>
                              </PopoverContent>
                            </Popover>
                          </FormLabel>
                        ...
                        <FormItem>
                          <FormLabel className="flex items-center gap-2">
                            ...
                            <Popover>
                              ...
                              <PopoverContent side="right" className="max-w-xs">
                                <p className="text-sm">
                                  Kriteria spesifik yang harus dipenuhi untuk
                                  menganggap inisiatif ini selesai.
                                </p>
                              </PopoverContent>
                            </Popover>
                          </FormLabel>
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-600">
                        Fitur untuk menambahkan task akan tersedia setelah
                        inisiatif dibuat. Anda dapat menambahkan dan mengelola
                        task dari halaman detail inisiatif.
                      </p>
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <Card className="border-2 border-orange-100">
                      <CardHeader>
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          tingkat kesulitan, dan keyakinan (skala 1-5)
                        </p>
                      </CardHeader>
                      <CardContent className="space-y-6">
                                  ...
                                  <Popover>
                                    ...
                                    >
                                      <p className="text-sm">
                                        ...
                                        terhadap pencapaian angka target dan
                                        tujuan bisnis.
                                        <br />
                                        <br />1 = Sangat Rendah, 5 = Sangat
                                        Tinggi
                                      </p>
                                    </PopoverContent>
                                  </Popover>
                              ...
                              <FormItem>
                                <FormLabel className="flex items-center gap-2">
                                  ...
                                  <Popover>
                                    ...
                                    >
                                      <p className="text-sm">
                                        Seberapa sulit implementasi inisiatif
                                        ini dalam hal resource, waktu, dan
                                        kompleksitas.
                                        <br />
                                        <br />1 = Sangat Mudah, 5 = Sangat Sulit
                                      </p>
                                    </PopoverContent>
                                  </Popover>
                                </FormLabel>
                              ...
                              <FormItem>
                                <FormLabel className="flex items-center gap-2">
                                  ...
                                  <Popover>
                                    ...
                                    >
                                      <p className="text-sm">
                                        Seberapa yakin Anda bahwa inisiatif ini
                                        akan berhasil mencapai target yang
                                        ditetapkan.
                                        <br />
                                        <br />1 = Sangat Rendah, 5 = Sangat
                                        Tinggi
